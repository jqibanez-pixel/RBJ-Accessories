...
.sidebar .logo img { height: 100px; width: auto; display: block; margin: 0 auto; }
.sidebar nav a { display: block; color: white; text-decoration: none; padding: 10px; margin-bottom: 5px; font-size: 15px; font-weight: 600; }
